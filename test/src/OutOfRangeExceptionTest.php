...
use Wayang\Exception\Spl\OutOfRangeException;
...
class OutOfRangeExceptionTest extends TestCase
{
  public function testMustBeClass(){
    $rc = new ReflectionClass(OutOfRangeException::class);
    $this->assertFalse($rc->isTrait());
    $this->assertFalse($rc->isInterface());
  }

  public function testMustBeSubclassOfOutOfRangeException(){
    $rc = new ReflectionClass(OutOfRangeException::class);
    $this->assertTrue($rc->isSubclassOf(\OutOfRangeException::class));
  }
